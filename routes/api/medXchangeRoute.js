...
const {dossierDetails, getConsultation,deletePatient,deleteConsultation, editPatient, getPatientById, addPatient} = require('../../controllers/medXchange/DossiersControllers')
const {
  notifications,
  sendNotifications,
